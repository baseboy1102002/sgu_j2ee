...
public class SearchService{
	private DAOService<NguoiDung> ndDAO = new DAOService<>();
	private DAOService<BaiViet> bvDAO = new DAOService<>();
	private DAOService<ThongTinKetBan> ttDao = new DAOService<>();
